...
if (!defined('CIVICRM_UF_DSN')) {
  define( 'CIVICRM_UF_DSN'           , 'mysql://test:test123@localhost/compucorptest?new_link=true');
}
...
if (!defined('CIVICRM_DSN')) {
  define( 'CIVICRM_DSN'          , 'mysql://test:test123@localhost/compucorptest_civi?new_link=true');
}
...
$civicrm_root = 'E:/projects/xampp_php_5.5.24/htdocs/compucorp/sites/all/modules/civicrm';
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define( 'CIVICRM_TEMPLATE_COMPILEDIR', 'E:/projects/xampp_php_5.5.24/htdocs/compucorp\\sites\\default\\files\\civicrm\\templates_c\\');
}
...
if (!defined('CIVICRM_UF_BASEURL')) {
  define( 'CIVICRM_UF_BASEURL'      , 'http://compucorptest.com/');
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', '20fab167cfae7492c5e83565ba093aa7');
}
...
// define( 'CIVICRM_MAIL_LOG', 'E:/projects/xampp_php_5.5.24/htdocs/compucorp\\sites\\default\\files\\civicrm\\templates_c\\/mail.log');
// }
